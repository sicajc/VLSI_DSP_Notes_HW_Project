...
static void main_gn_HPF(void)
{
  ...
  /* Initialize function 'gn_HPF' input arguments. */
  /* Initialize function input argument 'raw_img'. */
  /* Initialize function input argument 'T'. */
  /* Call the entry-point 'gn_HPF'. */
  argInit_512x512_flts13_En4(dv);
  gn_HPF(dv, argInit_flts13_En4(), filtered_img);
}
