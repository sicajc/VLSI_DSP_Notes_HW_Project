...
/* Include Files */
#include "_coder_gn_HPF_api.h"
#include "_coder_gn_HPF_mex.h"
...
static real_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *horizontal,
...
static void g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId);
static void gn_HPF_once(const emlrtStack *sp);
static void h_emlrt_marshallIn(const mxArray *src, real_T ret[262144]);
  ...
  const char_T *identifier)
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(horizontal), &thisId);
  emlrtDestroyArray(&horizontal);
  return y;
}
  ...
  emlrtMsgIdentifier *parentId)
{
  ...
  g_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 1, "y")),
                     &thisId);
  emlrtDestroyArray(&u);
}
...
static void gn_HPF_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&b_eml_mx, numerictype(sp, "DataTypeMode",
    ...
    "WordLength", 13.0, "FractionLength", 4.0, "BinaryPoint", 4.0, "Slope",
 ...
 * Return Type  : void
 */
void gn_HPF_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray *
                plhs[1])
{
  static real_T raw_img[262144];
  real_T horizontal;
  static real_T filtered_img[262144];
  ...
  horizontal = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "horizontal");
  e_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "T");

  /* Invoke the target function */
  gn_HPF(raw_img, horizontal, filtered_img);
...
/*
 * File trailer for _coder_gn_HPF_api.c
 *
 * [EOF]
 */
