...
static void hn_LPF_once(const emlrtStack *sp);
 ...
 * Return Type  : void
 */
void hn_LPF_api(const mxArray * const prhs[3], int32_T nlhs, const mxArray *
                plhs[1])
{
  ...
  hn_LPF(raw_img, horizontal, filtered_img);
...
/*
 * File trailer for _coder_hn_LPF_api.c
 *
 * [EOF]
 */
