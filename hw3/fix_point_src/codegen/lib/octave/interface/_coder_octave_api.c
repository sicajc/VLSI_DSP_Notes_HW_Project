...
static void i_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId);
static void j_emlrt_marshallIn(const mxArray *src, real_T ret[262144]);
...
static void octave_once(const emlrtStack *sp);
...
static void octave_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&d_eml_mx, numerictype(sp, "DataTypeMode",
    ...
    "WordLength", 14.0, "FractionLength", 2.0, "BinaryPoint", 2.0, "Slope", 0.25,
    "FixedExponent", -2.0, &emlrtMCI));
  emlrtAssignP(&c_eml_mx, numerictype(sp, "DataTypeMode",
    "Scaled double: binary point scaling", "DataType", "ScaledDouble",
    "WordLength", 8.0, "FractionLength", 3.0, "BinaryPoint", 3.0, "Slope", 0.125,
    "FixedExponent", -3.0, &emlrtMCI));
  emlrtAssignP(&b_eml_mx, numerictype(sp, "DataTypeMode",
    "Scaled double: binary point scaling", "DataType", "ScaledDouble",
    "WordLength", 13.0, "FractionLength", 3.0, "BinaryPoint", 3.0, "Slope",
 ...
 * Return Type  : void
 */
void octave_api(const mxArray * const prhs[4], int32_T nlhs, const mxArray *
                plhs[1])
{
  ...
  e_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "T");

  /* Invoke the target function */
  octave(raw_img, stride, n, filtered_img);
...
/*
 * File trailer for _coder_octave_api.c
 *
 * [EOF]
 */
