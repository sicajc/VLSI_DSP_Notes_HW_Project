...
/* Include Files */
#include "_coder_downSampler_api.h"
#include "_coder_downSampler_mex.h"
...
static void emlrt_marshallIn(const emlrtStack *sp, const mxArray *img, const
  char_T *identifier, real_T y[262144]);
static const mxArray *emlrt_marshallOut(const emlrtStack *sp, const real_T u
  [262144]);
...
static void h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId);
static void i_emlrt_marshallIn(const mxArray *src, real_T ret[262144]);
...
static void downSampler_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&c_eml_mx, numerictype(sp, "DataTypeMode",
    ...
    "WordLength", 27.0, "FractionLength", 18.0, "BinaryPoint", 18.0, "Slope",
    3.814697265625E-6, "FixedExponent", -18.0, &emlrtMCI));
  emlrtAssignP(&b_eml_mx, numerictype(sp, "DataTypeMode",
    "Scaled double: binary point scaling", "DataType", "ScaledDouble",
    "WordLength", 27.0, "FractionLength", 19.0, "BinaryPoint", 19.0, "Slope",
    1.9073486328125E-6, "FixedExponent", -19.0, &emlrtMCI));
  ...
  emlrtMsgIdentifier *parentId)
{
  ...
  g_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 0, "x")),
                     &thisId);
  thisId.fIdentifier = "y";
  h_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 1, "y")),
                     &thisId);
  emlrtDestroyArray(&u);
}
...
static void i_emlrt_marshallIn(const mxArray *src, real_T ret[262144])
{
  ...
  r = (real_T (*)[262144])emlrtMxGetData(mxInt);
  for (i = 0; i < 262144; i++) {
    ret[i] = (*r)[i];
  }
 ...
 * Return Type  : void
 */
void downSampler_api(const mxArray * const prhs[6], int32_T nlhs, const mxArray *
                     plhs[1])
{
  static real_T img[262144];
  real_T stride;
  real_T odd;
  real_T n;
  real_T horizontal;
  static real_T downSampledimg[262144];
  ...
  emlrt_marshallIn(&st, emlrtAliasP(prhs[0]), "img", img);
  stride = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "stride");
  odd = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "odd");
  n = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "n");
  horizontal = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[4]), "horizontal");
  e_emlrt_marshallIn(&st, emlrtAliasP(prhs[5]), "T");

  /* Invoke the target function */
  downSampler(img, stride, odd, n, horizontal, downSampledimg);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(&st, downSampledimg);
}
...
void downSampler_atexit(void)
{
  ...
  downSampler_xil_terminate();
  downSampler_xil_shutdown();
 ...
 * Return Type  : void
 */
void downSampler_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
 ...
 * Return Type  : void
 */
void downSampler_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_downSampler_api.c
 *
 * [EOF]
 */
