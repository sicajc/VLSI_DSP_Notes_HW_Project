 ...
 * File: _coder_filterSystem_api.c
 *
...
static const mxArray *b_numerictype(const emlrtStack *sp, const char * b, const
  char * c, const char * d, const char * e, emlrtMCInfo *location);
static void c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *wn, const
  char_T *identifier, real_T y[9]);
...
static real_T e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *N, const
  char_T *identifier);
static void emlrt_marshallIn(const emlrtStack *sp, const mxArray *xn, const
  char_T *identifier, real_T y[8]);
static const mxArray *emlrt_marshallOut(const emlrtStack *sp, const real_T u[8]);
static real_T f_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId);
static void filterSystem_once(const emlrtStack *sp);
...
static void g_emlrt_marshallIn(const emlrtStack *sp, const mxArray *T, const
  char_T *identifier);
...
static void j_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId);
static void k_emlrt_marshallIn(const mxArray *src, real_T ret[8]);
static void l_emlrt_marshallIn(const mxArray *src, real_T ret[9]);
...
static const mxArray *numerictype(const emlrtStack *sp, const char * b, const
  char * c, const char * d, const char * e, const char * f, real_T g, const char
  * h, real_T i, const char * j, real_T k, const char * l, real_T m, emlrtMCInfo
  *location);
  ...
  emlrtMsgIdentifier *parentId, real_T y[8])
{
  ...
  k_emlrt_marshallIn(emlrtAlias(u), y);
  emlrtDestroyArray(&u);
}
  ...
  char * c, const char * d, const char * e, emlrtMCInfo *location)
{
  ...
  return emlrtCallMATLABR2012b(sp, 1, &m, 4, pArrays, "numerictype", true,
    location);
}
  ...
  char_T *identifier, real_T y[9])
{
  ...
  d_emlrt_marshallIn(sp, emlrtAlias(wn), &thisId, y);
  emlrtDestroyArray(&wn);
}
  ...
  char_T *identifier, real_T y[8])
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  b_emlrt_marshallIn(sp, emlrtAlias(xn), &thisId, y);
...
static void filterSystem_once(const emlrtStack *sp)
{
  ...
  emlrtAssignP(&c_eml_mx, numerictype(sp, "DataTypeMode",
    "Scaled double: binary point scaling", "DataType", "ScaledDouble",
    "FractionLength", 14.0, "BinaryPoint", 14.0, "Slope", 6.103515625E-5,
    "FixedExponent", -14.0, &emlrtMCI));
  emlrtAssignP(&b_eml_mx, b_numerictype(sp, "DataTypeMode",
    "Scaled double: binary point scaling", "DataType", "ScaledDouble", &emlrtMCI));
  ...
  char_T *identifier)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  h_emlrt_marshallIn(sp, emlrtAlias(T), &thisId);
  emlrtDestroyArray(&T);
}
  ...
  emlrtMsgIdentifier *parentId)
{
  ...
  i_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 0, "x")),
                     &thisId);
  thisId.fIdentifier = "y";
  j_emlrt_marshallIn(sp, emlrtAlias(emlrtGetFieldR2017b(sp, u, 0, 1, "y")),
                     &thisId);
  emlrtDestroyArray(&u);
}
...
static void k_emlrt_marshallIn(const mxArray *src, real_T ret[8])
{
  ...
  r = (real_T (*)[8])emlrtMxGetData(mxInt);
  for (i = 0; i < 8; i++) {
    ret[i] = (*r)[i];
  }
...
static void l_emlrt_marshallIn(const mxArray *src, real_T ret[9])
{
  ...
  int32_T i;
  mxInt = emlrtImportFiIntArrayR2008b(src);
  r = (real_T (*)[9])emlrtMxGetData(mxInt);
  for (i = 0; i < 9; i++) {
    ret[i] = (*r)[i];
  }
  ...
  *location)
{
  ...
  return emlrtCallMATLABR2012b(sp, 1, &b_m, 12, pArrays, "numerictype", true,
    location);
}
 ...
 * Return Type  : void
 */
void filterSystem_api(const mxArray * const prhs[4], int32_T nlhs, const mxArray
                      *plhs[1])
{
  real_T xn[8];
  real_T wn[9];
  ...
  emlrt_marshallIn(&st, emlrtAliasP(prhs[0]), "xn", xn);
  c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "wn", wn);
  N = e_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "N");
  g_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "T");

  /* Invoke the target function */
  filterSystem(xn, wn, N, b_yn);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(&st, b_yn);
}
...
void filterSystem_atexit(void)
{
  ...
  filterSystem_xil_terminate();
  filterSystem_xil_shutdown();
...
/*
 * File trailer for _coder_filterSystem_api.c
 *
 * [EOF]
 */
