...
HD_PWD='C:/Users/User/Desktop/VLSI_DSP_Notes_HW_Project/hw5/verilog/CORDIC_DEBUG/CORDIC_DEBUG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log QR_CORDIC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source QR_CORDIC.tcl
